 ...
 *   修改日期：2022年07月26日 星期二 08时52分23秒
 *   描    述：
 *
 *================================================================*/
...
typedef enum {
	...
	MODBUS_ADDR_PDU_GROUP_0_CHANGE_STATE = MODBUS_ADDR_EXCEPTION_ASSERT_FAILED_LINE + (2 / 2),
	MODBUS_ADDR_PDU_GROUP_0_RELAY_ID,
	MODBUS_ADDR_PDU_GROUP_0_CONTROL_STATE,
	MODBUS_ADDR_PDU_GROUP_1_CHANGE_STATE,
	MODBUS_ADDR_PDU_GROUP_1_RELAY_ID,
	MODBUS_ADDR_PDU_GROUP_1_CONTROL_STATE,
